...
def trainModel(model, trainData, validData, dataset, optim):
    ...
    def trainEpoch(epoch):
        ...
        for i in range(len(trainData)):
            ...
            #print 'idx : ', batchIdx, ' length ', batch.lengths
...
def main():
    ...
    if opt.redis:
        trainData = onmt.RedisDataset("train", opt.batch_size, True, reverse=opt.reverse, db=opt.db)
        validData = onmt.RedisDataset('valid', opt.batch_size, True, volatile=True, reverse=opt.reverse, db=opt.db)
    else:
